...
parser.add_argument('--model_dir', default='./experiments/new_model',
                    help="Experiment directory containing params.json")
parser.add_argument('--data_dir', default='data/fmnist',
                    help="Directory containing the dataset")
parser.add_argument('--sprite_filename', default='./experiments/fmnist__sprite.png',
...
if __name__ == '__main__':
    ...
    embedding_var = tf.Variable(embeddings, name='fmnist_embedding')

    eval_dir = os.path.join(args.model_dir, "tf_projector")
    ...
    with tf.Session() as sess:
        ...
        dataset = fmnist_dataset.test(args.data_dir)
    ...
    metadata_filename = "fmnist_metadata.tsv"
